...
$('.js-9').attr('src', 'images/leaf-79.png');
...
setTimeout(function(){$('.js-7').prop('disabled',false);$("input[name='uxbqsvpgyr']").attr('value', 'wjeiotvapoyavfe');},1000);
$('form').h5Validate();setTimeout(function(){$('.js-8').prop('disabled',false);$("input[name='uxbqsvpgyr']").attr('value', 'wjeiotvapoyavfe');},1000);
var wl = new woolite();
wl.init();
